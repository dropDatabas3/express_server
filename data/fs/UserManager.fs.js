...
async function test() {
    ...
    await user.create({ email: 'tomas@tomas.com', password: 'contraseña5', role: '0', photo: 'foto.jpg' })
    console.log('Tratamos de crear un usuario con password:null para verificar que se soliciten todos los campos')
    await user.create({ email: 'tomas@tomas.com', password: null, role: '0', photo: 'foto.jpg' })
    console.log('Usuario de prueba: Se le setea un id por deafault para poder probar metodos readOne() y destroy()')
    await user.create({ email: 'luis@luis.com', password: 'contraseña3', role: '0', photo: 'foto.jpg', id: '298791076a493adfb6a48ef4' })
